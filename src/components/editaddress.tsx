        ...
        <div className="mx-auto max-w-7xl p-4 bg-white">
          ...
          relative inline-flex h-[25px] w-[44px] shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
            ...
            pointer-events-none inline-block h-[20px] w-[20px] transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`}
                    ...
                    <button type="button" className="w-full px-5 py-2.5 mb-2 text-sm font-medium text-[#1F304A] bg-white  focus:outline-none  rounded-lg text-center">Delete Address</button>
                    <button type="button" className="w-full px-5 py-2.5 text-sm font-medium text-white bg-[#1F304A] hover:bg-gray-800 focus:outline-none  rounded-lg text-center ">Submit</button>
