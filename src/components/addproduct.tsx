                    ...
                    <div className="grid grid-cols-2 gap-4 bg-white sm:rounded-lg mt-5 shadow">
                        ...
                        <div className='my-10 p-5'>
                            ...
                            <div className="form-control w-full max-w-xs  ">
                                ...
                                <select className="select select-bordered border-gray-500">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Product Name" className="input border-gray-500  w-full max-w-xs " />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Product DESC" className="input border-gray-500  w-full max-w-xs " />
                            </div>
