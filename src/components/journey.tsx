...
function journey() {
    return (
        <div className="mx-auto font-mtsans bg-white">
            <div className="hero h-96 md:h-[35em] overflow-hidden" style={{
                backgroundImage: `url(${Myjour.src})`,
            }}>
                <div className="hero-overlay bg-opacity-0"></div>
                <div className="translate-x-[4em] sm:translate-x-4 md:translate-x-0 hero-content max-w-xs md:max-w-full justify-end text-center md:text-left text-neutral-content w-full">
            ...
            <div className="flex flex-row flex-nowrap gap-4 carousel carousel-center text-md bg-white overflow-x-hidden hover:overflow-x-scroll max-w-7xl mx-auto">
                <div className="min-w-[24em] ml-5 p-6 md:p-8 border-x bg-gradient-to-b from-[ #0F172A] to-[#BCBCBC]">
                ...
                <div className="min-w-[24em] ml-5 p-6 md:p-8 border- bg-gradient-to-b from-[ #0F172A] to-[#BCBCBC]">
                ...
                <div className="min-w-[24em] ml-5 mr-5 p-6 md:p-8 border-x bg-gradient-to-b from-[ #0F172A] to-[#BCBCBC]">
