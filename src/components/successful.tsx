                ...
                <div className="container mx-auto px-4  ">
                    ...
                    <div className="w-full max-w-full md:max-w-xl rounded-2xl bg-white mt-2 m-auto">
                        ...
                        <div className='flex justify-between'>
                            <button type="button" className="w-1/4 px-5 py-2.5 text-sm font-medium text-gray-900 bg-gray-200 hover:bg-gray-300  focus:outline-none  rounded-lg text-center mt-4">Home</button>
